...
pub const struct_AOEFFHdr = extern struct {
    ...
    hEntry: u32 = @import("std").mem.zeroes(u32),
    hSectOff: u32 = @import("std").mem.zeroes(u32),
    hSectSize: u32 = @import("std").mem.zeroes(u32),
    hSymbOff: u32 = @import("std").mem.zeroes(u32),
    hSymbSize: u32 = @import("std").mem.zeroes(u32),
    hStrTabOff: u32 = @import("std").mem.zeroes(u32),
    hStrTabSize: u32 = @import("std").mem.zeroes(u32),
    hRelDirOff: u32 = @import("std").mem.zeroes(u32),
    hRelDirSize: u32 = @import("std").mem.zeroes(u32),
};
pub const AOEFFheader = struct_AOEFFHdr;
pub const struct_AOEFFSctHdr = extern struct {
    shSectName: [8]u8 = @import("std").mem.zeroes([8]u8),
    shSectOff: u32 = @import("std").mem.zeroes(u32),
    shSectSize: u32 = @import("std").mem.zeroes(u32),
    shSectRel: u32 = @import("std").mem.zeroes(u32),
};
pub const AOEFFSectHeader = struct_AOEFFSctHdr;
pub const struct_AOEFFSymEnt = extern struct {
    seSymbName: u32 = @import("std").mem.zeroes(u32),
    seSymbSize: u32 = @import("std").mem.zeroes(u32),
    seSymbVal: u32 = @import("std").mem.zeroes(u32),
    seSymbInfo: u8 = @import("std").mem.zeroes(u8),
...
pub const AOEF_FT_SLIB: c_int = 3;
pub const AOEF_FT_KERN: c_int = 4;
pub const enum_AOEF_BIN_FILETYPE = c_uint;
pub const AOEFbin_ft = enum_AOEF_BIN_FILETYPE;
pub const struct_AOEF_BIN = extern struct {
    binarytype: AOEFbin_ft = @import("std").mem.zeroes(AOEFbin_ft),
...
pub const AOEFbin = struct_AOEF_BIN;
...
pub const AH_ID2 = 'E';
pub const AH_ID3 = 'F';
pub const AHID_0 = @as(c_int, 0);
pub const AHID_1 = @as(c_int, 1);
pub const AHID_2 = @as(c_int, 2);
...
pub inline fn SE_GET_LOC(i: anytype) @TypeOf(i & @as(c_int, 0xf)) {
    _ = &i;
    return i & @as(c_int, 0xf);
}
pub inline fn SE_SET_INFO(t: anytype, l: anytype) @TypeOf((t << @as(c_int, 4)) | (l & @as(c_int, 0xf))) {
    _ = &t;
    _ = &l;
    return (t << @as(c_int, 4)) | (l & @as(c_int, 0xf));
}
pub const SE_NONE_T = @as(c_int, 0);
...
pub const RE_ARU32_MEM9 = @as(c_int, 1);
pub const RE_ARU32_IR24 = @as(c_int, 2);
pub const RE_ARU32_IR19 = @as(c_int, 3);
